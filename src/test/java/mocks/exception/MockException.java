...
public class MockException {
    ...
    public static final NotFoundClassificatorException NOT_FOUND_CLASSIFICATOR_EXCEPTION = new NotFoundClassificatorException(String.format(ExceptionHelper.NOT_FOUND_CLASSIFICATOR,CODE_NOT_FOUND));
}
